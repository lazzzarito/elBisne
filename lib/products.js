...
function mapRow(row) {
  ...
  // Una sola categoría por producto: `category_id` es la única fuente de
  // verdad. Antes esto priorizaba product_categories[0] sobre el FK, así que
  // un producto con dos filas en la tabla puente aparecía con la "categoría
  // equivocada" según de dónde viniera la query.
