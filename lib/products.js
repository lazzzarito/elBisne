...
function mapRow(row) {
  ...
  // verdad. Priorizar la tabla puente hacía que un producto con varias filas
  // apareciera con la categoría equivocada según qué consulta lo trajera.
...
// Todos los slugs (urls /product/[id])
